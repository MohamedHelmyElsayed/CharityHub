    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-3xl shadow-xl p-8">
            ...
            <a href="{{ route('auth.google') }}"
               class="mt-4 flex items-center justify-center gap-3 w-full py-3 px-4 border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 rounded-xl font-semibold text-gray-700 transition-all duration-200 group">
            ...
            @error('google')
                <p class="mt-2 text-red-500 text-sm text-center">{{ $message }}</p>
            @enderror
