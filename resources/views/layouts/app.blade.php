...
<head>
    ...
    <meta name="description"
        content="@yield('meta_description', 'Join CharityHub to donate to impactful campaigns, volunteer your time, and track your real-world impact.')">
    ...
    <meta property="og:description"
        content="@yield('og_description', 'Donate, volunteer, and track impact with transparent charitable giving.')">
...
<body class="antialiased bg-slate-50 text-slate-900 selection:bg-blue-200 selection:text-blue-900">
    ...
    @if(session('success'))
        <div
            class="fixed top-24 right-4 z-50 bg-slate-900 text-white px-6 py-4 rounded-2xl shadow-2xl shadow-slate-900/20 flex items-center space-x-3 animate-slide-in border border-slate-700">
    ...
    @if(session('error') || $errors->any())
        <div
            class="fixed top-24 right-4 z-50 bg-white text-slate-900 px-6 py-4 rounded-2xl shadow-2xl flex items-center space-x-3 animate-slide-in border border-red-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center space-x-3 mb-6">
                        <div
                            class="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center shadow-md shadow-blue-500/20">
                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                <path
                                    d="M12 21.593c-5.63-5.539-11-10.297-11-14.402 0-3.791 3.068-5.191 5.281-5.191 1.312 0 4.151.501 5.719 4.457 1.59-3.968 4.464-4.447 5.726-4.447 2.54 0 5.274 1.621 5.274 5.181 0 4.069-5.136 8.625-11 14.402z" />
                            </svg>
                    ...
                    <p class="text-base leading-relaxed mb-6 text-slate-500 max-w-md">Empowering change through
                        transparent, trustworthy, and auditable charitable giving. Every donation is tracked, verified,
                        and makes a real difference.</p>
                    <div class="flex space-x-4">
                        {{-- Social Icons --}}
                        <a href="#"
                            class="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-400 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-all"><svg
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm font-medium">
                        <li><a href="{{ route('campaigns.index') }}"
                                class="text-slate-500 hover:text-blue-600 transition-colors">Explore Campaigns</a></li>
                        <li><a href="{{ route('volunteering.index') }}"
                                class="text-slate-500 hover:text-blue-600 transition-colors">Volunteering
                                Opportunities</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm font-medium">
                        <li><span class="flex items-center gap-2 text-slate-500"><svg class="w-4 h-4 text-emerald-500"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                </svg> PCI-DSS Compliant</span></li>
                        <li><span class="flex items-center gap-2 text-slate-500"><svg class="w-4 h-4 text-emerald-500"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                                </svg> GDPR Compliant</span></li>
                        <li><span class="flex items-center gap-2 text-slate-500"><svg class="w-4 h-4 text-emerald-500"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                </svg> Full Audit Trail</span></li>
                        <li><a href="{{ route('verify.index') }}"
                                class="text-slate-500 hover:text-blue-600 transition-colors flex items-center gap-2"><svg
                                    class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                                </svg> Verify a Certificate</a></li>
                    </ul>
                </div>
            </div>
            <div
                class="mt-16 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div class="flex space-x-6 text-sm font-medium text-slate-500">
                    <a href="{{ route('privacy') }}" class="hover:text-slate-900 transition-colors">Privacy Policy</a>
                    <a href="{{ route('terms') }}" class="hover:text-slate-900 transition-colors">Terms of Service</a>
                </div>
            </div>
        </div>
    </footer>
