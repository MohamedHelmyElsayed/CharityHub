        ...
        <div class="flex-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden">
                    ...
                    <h3 class="text-4xl font-extrabold text-gray-900">$124,500</h3>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden">
                    ...
                    <h3 class="text-4xl font-extrabold text-gray-900">12</h3>
                    <p class="text-sm text-gray-500 mt-2 font-medium">3 requiring attention</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 relative overflow-hidden">
                    ...
                    <h3 class="text-4xl font-extrabold text-gray-900">84</h3>
                    <p class="text-sm text-green-600 mt-2 font-medium flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"></path></svg>
                        5 new this week
                    </p>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            @foreach([
                                ['name' => 'John Doe', 'camp' => 'Clean Water Initiative', 'amt' => 150, 'date' => 'Today, 10:42 AM'],
                                ['name' => 'Alice Smith', 'camp' => 'Education for All', 'amt' => 50, 'date' => 'Today, 09:15 AM'],
                                ['name' => 'Bob Johnson', 'camp' => 'Disaster Relief Fund', 'amt' => 500, 'date' => 'Yesterday'],
                                ['name' => 'Emma Davis', 'camp' => 'Wildlife Conservation', 'amt' => 25, 'date' => 'Oct 23, 2023'],
                            ] as $item)
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900 flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-full bg-primary-100 text-primary-700 flex items-center justify-center font-bold">{{ substr($item['name'], 0, 1) }}</div>
                                    {{ $item['name'] }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600 font-medium">{{ $item['camp'] }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-extrabold text-gray-900">${{ number_format($item['amt'], 2) }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $item['date'] }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm">
                                    <span class="px-3 py-1 inline-flex text-xs leading-5 font-bold rounded-full bg-green-100 text-green-800">Completed</span>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
