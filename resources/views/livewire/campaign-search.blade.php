<div>
    ...
    {{-- Loading Indicator --}}
    <div wire:loading class="w-full text-center py-4 mb-8">
        <div class="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-full text-white bg-blue-600">
